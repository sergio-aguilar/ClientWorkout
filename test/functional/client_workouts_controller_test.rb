...
class ClientWorkoutsControllerTest < ActionController::TestCase
  ...
  test "should create client_workout" do
    assert_difference('ClientWorkout.count') do
      post :create, client_workout: { client_name: @client_workout.client_name, date_of_workout: @client_workout.date_of_workout, duration_mins: @client_workout.duration_mins, paid_amount: @client_workout.paid_amount, trainer: @client_workout.trainer }
    end
  ...
  test "should update client_workout" do
    put :update, id: @client_workout, client_workout: { client_name: @client_workout.client_name, date_of_workout: @client_workout.date_of_workout, duration_mins: @client_workout.duration_mins, paid_amount: @client_workout.paid_amount, trainer: @client_workout.trainer }
    assert_redirected_to client_workout_path(assigns(:client_workout))
  end
